...
After covering multiple backend technologies (MongoDB, GraphQL, Prisma, Sequelize, SQL), this session focused on how to interact with those APIs from the frontend using React.
...
This project demonstrates different approaches to data fetching in React:
...
- Comparing different data fetching methods
